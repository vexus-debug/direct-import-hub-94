    ...
    tutorials: [
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open your clinic dashboard", body: "Sign in and choose your clinic. The Dashboard is the starting point for appointments, patients, clinical work, finance and stock.", image: "/tutorials/appointments.png", imageAlt: "Open your clinic dashboard — Clinexus dental dashboard" },
          { title: "Use the sidebar groups", body: "Open Patient Care for patients and appointments, Clinical for dental work, Finance for money matters, Reports for performance, and Inventory & Supply for stock.", image: "/tutorials/inventory.png", imageAlt: "Use the sidebar groups — Clinexus dental dashboard" },
          ...
          { title: "Check your access", body: "If a page is missing from the sidebar, ask an owner or admin to review your staff role. Access to billing, records and settings depends on that role.", image: "/tutorials/staff.png", imageAlt: "Check your access — Clinexus dental dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Save your clinic details", body: "Enter the clinic information your team and patients should see, optionally select Upload Logo, then select Save Changes.", image: "/tutorials/patients.png", imageAlt: "Save your clinic details — Clinexus dental dashboard" },
          { title: "Add your team", body: "Open Staff, select Add Staff, enter the staff member's details and role, then complete the dialog to create the account.", image: "/tutorials/staff.png", imageAlt: "Add your team — Clinexus dental dashboard" },
          ...
          { title: "Add your services", body: "Open Treatments, stay on Catalog, select Add Treatment, enter the service details and save it for use in plans and billing.", image: "/tutorials/billing.png", imageAlt: "Add your services — Clinexus dental dashboard" },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Open Clinic Profile", body: "In Settings, choose the Clinic Profile tab and review the clinic name and contact details.", image: "/tutorials/settings.png", imageAlt: "Open Clinic Profile — Clinexus dental dashboard" },
          ...
          { title: "Turn on the right notifications", body: "Open Notifications and choose the switches for Appointment Reminders, Payment Alerts, Lab Completion Alerts and Low Stock Alerts.", image: "/tutorials/inventory.png", imageAlt: "Turn on the right notifications — Clinexus dental dashboard" },
          { title: "Manage members and chairs", body: "If you are an admin, use Members & Roles to edit details or change a role. Use Chairs to add or remove treatment chairs.", image: "/tutorials/staff.png", imageAlt: "Manage members and chairs — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Add a treatment", body: "Select Add Treatment and enter the treatment name, category, price and other required details.", image: "/tutorials/dashboard.png", imageAlt: "Add a treatment — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Update the main content", body: "Edit the text and colours for the selected section. Use Reset to template colours if you want to restore the template palette.", image: "/tutorials/dashboard.png", imageAlt: "Update the main content — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Review an order", body: "Use View on an order to inspect its items, customer details and current status.", image: "/tutorials/dashboard.png", imageAlt: "Review an order — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Scan recent activity", body: "Review the activity list to see what changed and when.", image: "/tutorials/dashboard.png", imageAlt: "Scan recent activity — Clinexus dental dashboard" },
          { title: "Investigate an entry", body: "Use the entry details to compare the action with the patient, invoice, staff or setting involved.", image: "/tutorials/staff.png", imageAlt: "Investigate an entry — Clinexus dental dashboard" },
          { title: "Follow up safely", body: "If an entry is unexpected, review the related record and ask an owner or admin to confirm the next action.", image: "/tutorials/dashboard.png", imageAlt: "Follow up safely — Clinexus dental dashboard" },
        ],
      },
    ],
  },
    ...
    tutorials: [
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Open the right record tab", body: "Move between Clinical Notes, treatment plans, billing, prescriptions and the other available patient tabs.", image: "/tutorials/billing.png", imageAlt: "Open the right record tab — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Document the visit", body: "Enter the relevant Subjective, Objective, Assessment and Plan information, along with any treatment details requested by the form.", image: "/tutorials/dashboard.png", imageAlt: "Document the visit — Clinexus dental dashboard" },
          { title: "Review before saving", body: "Check tooth numbers, surfaces and follow-up instructions, then save the note using the form's save action.", image: "/tutorials/dental-charts.png", imageAlt: "Review before saving — Clinexus dental dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Choose the patient and file", body: "In the Upload Document dialog, select the patient, choose the file and enter the document details requested.", image: "/tutorials/documents.png", imageAlt: "Choose the patient and file — Clinexus dental dashboard" },
          { title: "Complete the upload", body: "Finish the dialog to attach the document to the patient record.", image: "/tutorials/patients.png", imageAlt: "Complete the upload — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Keep templates ready", body: "Use Templates and select New Template to create a reusable form. Use Upload Scanned or Import Templates when you already have forms outside the app.", image: "/tutorials/dashboard.png", imageAlt: "Keep templates ready — Clinexus dental dashboard" },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Choose the patient and service", body: "Select the patient, clinician, treatment or service, and any other required booking details.", image: "/tutorials/appointments.png", imageAlt: "Choose the patient and service — Clinexus dental dashboard" },
          { title: "Choose the time", body: "Use the date and time controls to select an available slot. Check the day, week or month view if you need a wider view.", image: "/tutorials/dashboard.png", imageAlt: "Choose the time — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Find or add the patient", body: "Select an existing patient or complete the patient details requested by the Walk-In dialog.", image: "/tutorials/waiting-list.png", imageAlt: "Find or add the patient — Clinexus dental dashboard" },
          { title: "Add the visit details", body: "Choose the clinician, service and any required timing or notes.", image: "/tutorials/dashboard.png", imageAlt: "Add the visit details — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        level: "Beginner",
        steps: [
          { title: "Check in from Appointments", body: "Find the appointment and select Check in when the patient arrives.", image: "/tutorials/appointments.png", imageAlt: "Check in from Appointments — Clinexus dental dashboard" },
          ...
          { title: "Call the next patient", body: "Select Call Next to move the next patient forward, or use Check In to add a patient directly to the queue.", image: "/tutorials/waiting-list.png", imageAlt: "Call the next patient — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Add breaks", body: "Block break periods so those times are not offered as available appointment slots.", image: "/tutorials/appointments.png", imageAlt: "Add breaks — Clinexus dental dashboard" },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Select the patient", body: "Open Dental Charts and use Select patient to load the correct chart.", image: "/tutorials/dental-charts.png", imageAlt: "Select the patient — Clinexus dental dashboard" },
          ...
          { title: "Save the entry", body: "Select Save Procedure or Add Entry, depending on the form, then check the procedure history for the new record.", image: "/tutorials/dashboard.png", imageAlt: "Save the entry — Clinexus dental dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Add the plan details", body: "Choose the patient, enter the Plan name, select a Priority and set a Target End Date when one is known.", image: "/tutorials/patients.png", imageAlt: "Add the plan details — Clinexus dental dashboard" },
          { title: "Add visits", body: "Select Add Visit and enter the treatment, tooth number, visit number, estimated cost and scheduled date for each part of the plan.", image: "/tutorials/estimates.png", imageAlt: "Add visits — Clinexus dental dashboard" },
          { title: "Review progress", body: "Open the plan card to track Pending, Scheduled, In-progress or Skipped items.", image: "/tutorials/dashboard.png", imageAlt: "Review progress — Clinexus dental dashboard" },
          { title: "Close the plan", body: "Use Pause Plan or Complete Plan when the treatment status changes. Cancel a plan only when it will not continue.", image: "/tutorials/dashboard.png", imageAlt: "Close the plan — Clinexus dental dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Choose the patient", body: "Select the patient whose prescription you are preparing.", image: "/tutorials/prescriptions.png", imageAlt: "Choose the patient — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Add case requirements", body: "Enter shade or colour requirements, material preferences and any notes the laboratory needs.", image: "/tutorials/treatment-materials.png", imageAlt: "Add case requirements — Clinexus dental dashboard" },
          { title: "Move the case forward", body: "Use the case actions to move it through Pending, Sent, In Progress, Completed and Received.", image: "/tutorials/dashboard.png", imageAlt: "Move the case forward — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        level: "Intermediate",
        steps: [
          { title: "Check the patient in", body: "Use Check in on the appointment or move the patient through Waiting List with Call Next.", image: "/tutorials/waiting-list.png", imageAlt: "Check the patient in — Clinexus dental dashboard" },
          { title: "Review the record", body: "Open the patient profile, review the history, and check the dental chart before treatment.", image: "/tutorials/dental-charts.png", imageAlt: "Review the record — Clinexus dental dashboard" },
          { title: "Record care", body: "Add the procedure to the chart, update the treatment plan when needed, and write the clinical note.", image: "/tutorials/treatments.png", imageAlt: "Record care — Clinexus dental dashboard" },
          { title: "Finish the next step", body: "Create a prescription, consent or lab case when the visit requires it, then arrange the follow-up appointment.", image: "/tutorials/consent-forms.png", imageAlt: "Finish the next step — Clinexus dental dashboard" },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Choose the patient", body: "Select the patient and add the treatments, products or other billable items.", image: "/tutorials/treatments.png", imageAlt: "Choose the patient — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Send it to the patient", body: "Use Send on the estimate when it is ready for review.", image: "/tutorials/estimates.png", imageAlt: "Send it to the patient — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Link the invoice", body: "In Create Payment Plan, select the invoice and enter the installment schedule requested by the patient.", image: "/tutorials/payment-plans.png", imageAlt: "Link the invoice — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Create a payout", body: "If you manage commissions, open Commissions and select New Payout. Enter the staff member, amount and related details.", image: "/tutorials/staff.png", imageAlt: "Create a payout — Clinexus dental dashboard" },
          { title: "Record payment", body: "Open the payout and select Record Payment when the commission has been paid.", image: "/tutorials/commissions.png", imageAlt: "Record payment — Clinexus dental dashboard" },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: "Review the snapshot", body: "Check Total Revenue, Revenue This Month and the War Chest reserve before changing a rule.", image: "/tutorials/dashboard.png", imageAlt: "Review the snapshot — Clinexus dental dashboard" },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Record usage", body: "Use Use on the relevant row, enter the quantity consumed and confirm the Use Stock action.", image: "/tutorials/dashboard.png", imageAlt: "Record usage — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Set the quantity", body: "Enter the quantity used for one procedure so the clinic can track consumption consistently.", image: "/tutorials/dashboard.png", imageAlt: "Set the quantity — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: "Start a transaction", body: "Select Record Inventory Transaction and choose the item and transaction type.", image: "/tutorials/inventory.png", imageAlt: "Start a transaction — Clinexus dental dashboard" },
          { title: "Enter the cost details", body: "Add the quantity, amount, date and notes requested by the dialog.", image: "/tutorials/dashboard.png", imageAlt: "Enter the cost details — Clinexus dental dashboard" },
          { title: "Save and verify", body: "Complete the dialog, then check the transaction list and the item's current stock or cost information.", image: "/tutorials/dashboard.png", imageAlt: "Save and verify — Clinexus dental dashboard" },
        ],
      },
    ],
  },
    ...
    tutorials: [
      {
        ...
        steps: [
          ...
          { title: "Choose the date range", body: "Set the From and To dates or months for the period you want to review.", image: "/tutorials/dashboard.png", imageAlt: "Choose the date range — Clinexus dental dashboard" },
          { title: "Read the key numbers", body: "Review the KPI cards, revenue trend, treatment mix and dentist performance table.", image: "/tutorials/dashboard.png", imageAlt: "Read the key numbers — Clinexus dental dashboard" },
      ...
      },
      {
        ...
        level: "Advanced",
        steps: [
          { title: "Open Advanced Analytics", body: "Choose Advanced Analytics from the Reports group. Access is limited to the roles allowed by your clinic.", image: "/tutorials/staff.png", imageAlt: "Open Advanced Analytics — Clinexus dental dashboard" },
          { title: "Start with the overview", body: "Review the available dashboards and headline metrics before narrowing your investigation.", image: "/tutorials/dashboard.png", imageAlt: "Start with the overview — Clinexus dental dashboard" },
          { title: "Compare the charts", body: "Use the displayed charts to compare revenue, activity and performance across the available periods or categories.", image: "/tutorials/dashboard.png", imageAlt: "Compare the charts — Clinexus dental dashboard" },
          { title: "Turn an insight into action", body: "Use the result to adjust schedules, treatment catalogues, stock levels or follow-up work, then review the next reporting period.", image: "/tutorials/schedules.png", imageAlt: "Turn an insight into action — Clinexus dental dashboard" },
        ],
      },
      {
        ...
        level: "Advanced",
        steps: [
          { title: "Open Profitability", body: "Choose Profitability from Finance when your role has access to the page.", image: "/tutorials/staff.png", imageAlt: "Open Profitability — Clinexus dental dashboard" },
          ...
          { title: "Look for patterns", body: "Compare the treatment, staff or period details shown on the page to identify areas that need attention.", image: "/tutorials/staff.png", imageAlt: "Look for patterns — Clinexus dental dashboard" },
          { title: "Follow up in the source screen", body: "Use Billing, Expenses, Treatments or Reports to investigate the record behind an unexpected result.", image: "/tutorials/reports.png", imageAlt: "Follow up in the source screen — Clinexus dental dashboard" },
        ],
      },
    ],
  },
